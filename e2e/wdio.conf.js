...
const sourceSpecDirectory = `features/featureFiles`;
...
exports.config = {
    ...
    cucumberOpts: {
        ...
        tagExpression: '@Ci',  // <string> (expression) only execute the features or scenarios with tags matching the expression
